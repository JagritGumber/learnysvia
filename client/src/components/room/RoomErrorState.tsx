...
export function RoomErrorState({ error }: RoomErrorStateProps) {
  return (
    <div className="min-h-svh bg-base-100 flex flex-col items-center justify-center">
...
export function PollsErrorState({ error }: PollsErrorStateProps) {
  return (
    <div className="min-h-[calc(100svh)] bg-base-100 flex flex-col items-center justify-center">
